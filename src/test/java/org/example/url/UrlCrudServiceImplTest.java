...
class UrlCrudServiceImplTest {
    ...
    @Test
    void testCreateShortUrlWithoutUser() {
        DtoCreateUrlRequest request = DtoCreateUrlRequest.builder()
                .longUrl("https://example.com")
                .expiryDate(LocalDateTime.now().plusDays(1))
                .build();
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            urlCrudService.createShortUrl(request, null);
        }, "Creating a short URL without a user should throw an IllegalArgumentException");
    }
